    ...
    <header className="h-16 flex items-center justify-between px-6 bg-panel border-b border-neutral-100 shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xl font-semibold text-main-text leading-tight">
            {userName}
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 ">
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            placeholder="Search"
            className="
              h-11 pl-10 pr-14 text-base text-neutral-700 placeholder:text-inactive-text
               border border-neutral-200 rounded-xl outline-none
              focus:border-brand-orange focus:ring-2 focus:ring-brand-orange/20 transition-all
              w-56
            "
          />
          <kbd className="absolute right-3 text-sm font-medium text-navbar-secondary-text border border-neutral-200 rounded px-1.5 py-0.5">
            ⌘K
          </kbd>
        </div>
